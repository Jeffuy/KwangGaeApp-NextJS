...
const FigthButtons = () => {
	const { status, setShowError, lastRed, lastBlue, startFight, endFight, redScore, blueScore, redWarning, blueWarning } = useContext(FightContext);
			...
			<div className="row">
				<div className="col-6 mb-2">
					<div className="btn-group-vertical">
						...
						<button className="btn btn-dark btn-lg btn-block mt-3 mb-1 shadow-none" type="button" onClick={status ? undefined : () => startFight()}>
							Start
						</button>
					</div>
				</div>
				<div className="col-6 mb-2">
					<div className="btn-group-vertical">
						...
						<button className="btn btn-dark btn-lg btn-block mt-3 mb-1 shadow-none" type="button" onClick={() => endFight()}>
							End
						</button>
					</div>
				</div>

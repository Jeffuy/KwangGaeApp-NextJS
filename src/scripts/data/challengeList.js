export const challengesList = [
	...
	{ text: 'un punteo con yop y pega gancho a la cabeza', points: 4, completed: false },
	{ text: 'un punteo con yop y pega dolyo a la cabeza con la misma pierna', points: 4, completed: false },
	{ text: 'un doble punteo con yop y pega dolyo con la otra pierna', points: 3, completed: false },
	...
	{ text: 'un punteo que se convierta en una descendente que puntue', points: 5, completed: false },
	{ text: 'que una pelea termine sin que recibas ningún punto', points: 5, completed: false },
	{ text: 'que una pelea termine habiendo conseguido mas de 10 puntos', points: 5, completed: false },
	{ text: 'que el rival te haga 2 puntos al empezar el combate y luego supéralo', points: 3, completed: false },
	{ text: 'que el rival te haga 1 punto al empezar el combate y luego supéralo', points: 2, completed: false },
	{ text: 'que el rival te haga 3 puntos al empezar el combate y luego supéralo', points: 4, completed: false },
	{ text: 'que el rival te haga 4 puntos al empezar el combate y luego supéralo', points: 5, completed: false },
	{ text: 'que el rival te haga 5 puntos al empezar el combate y luego supéralo', points: 6, completed: false },
	...
	{ text: 'puntos solo con patadas a zona alta y gana el combate', points: 5, completed: false },
	{ text: 'puntos solo con puños y gana el combate', points: 5, completed: false },
];
